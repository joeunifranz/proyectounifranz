<?php
	...
	if($datos_venta->rowCount()==1){
		...
		if($datos_venta['cliente_id']==1){
			...
			$pdf->Cell(6,7,iconv("UTF-8", "ISO-8859-1",'Dir:'),0,0);
			$pdf->SetTextColor(97,97,97);
			$pdf->Cell(109,7,iconv("UTF-8", "ISO-8859-1",$datos_venta['cliente_ciudad'].", ".$datos_venta['cliente_direccion']),0,0);
		}
		...
		$pdf->SetTextColor(39,39,51);
		$pdf->MultiCell(0,9,iconv("UTF-8", "ISO-8859-1","***Para poder realizar un reclamo debe de presentar esta factura ***"),0,'C',false);
